...
class PODoneAppSCreen extends StatefulWidget {
  final String po;
  PODoneAppSCreen({this.po});

  @override
  State<PODoneAppSCreen> createState() => _PODoneAppSCreenState();
}

class _PODoneAppSCreenState extends State<PODoneAppSCreen> {
