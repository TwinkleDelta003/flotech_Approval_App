...
class POPendingApprovalSCreen extends StatefulWidget {
  final String po;

  const POPendingApprovalSCreen({Key key, this.po}) : super(key: key);
  @override
  State<POPendingApprovalSCreen> createState() =>
      _POPendingApprovalSCreenState();
}

class _POPendingApprovalSCreenState extends State<POPendingApprovalSCreen> {
  ...
  @override
  void initState() {
    if (widget.po != "") _findController.text = widget.po;
    _searchText = widget.po;
